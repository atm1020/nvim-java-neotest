...
M.test_cases_junit5 = {
	{
		input = '%TSTTREE18,provideArguments(dev.sirosh.case_folders.CaseFolderSourceArgumentsProviderTest),false,1,true,3,two param test,java.lang.reflect.Method\\, java.util.List,[engine:junit-jupiter]/[class:dev.sirosh.case_folders.CaseFolderSourceArgumentsProviderTest]/[test-template:provideArguments(java.lang.reflect.Method\\, java.util.List)]/[test-template-invocation:#15]',
		expected = {
			...
			unique_id = '[engine:junit-jupiter]/[class:dev.sirosh.case_folders.CaseFolderSourceArgumentsProviderTest]/[test-template:provideArguments(java.lang.reflect.Method\\, java.util.List)]/[test-template-invocation:#15]',
		},
	},
}
...
function M.get_test_id_for_junit_5method(project_name)
	return {
		{
			input = '[engine:junit-jupiter]/[class:org.springframework.samples.petclinic.owner.PetControllerTests]/[nested-class:ProcessCreationFormHasErrors]/[method:testProcessCreationFormWithBlankName()]',
			expected = project_name
				.. '@org.springframework.samples.petclinic.owner.PetControllerTests$ProcessCreationFormHasErrors#testProcessCreationFormWithBlankName()',
		},
		{
			input = '[engine:junit-jupiter]/[class:org.springframework.samples.petclinic.owner.PetControllerTests]/[method:testProcessCreationFormSuccess()]',
			expected = project_name
